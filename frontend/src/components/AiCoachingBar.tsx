...
export default function AiCoachingBar({ tips }: Readonly<AiCoachingBarProps>) {
  return (
    <aside
      ...
      data-node-id="32:690"
      className="flex h-[180px] min-w-0 flex-1 items-start justify-between gap-[24px] overflow-x-auto rounded-[5px] bg-vp-surface px-[22px] pt-[12.6px] shadow-[inset_0_0_0_1px_#dadada]"
