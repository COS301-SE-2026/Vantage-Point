import svgPaths from "./svg-g4pupw57ua";
import imgRectangle1 from "./97d8c9201149029b885bb52960ef71eae5ce7ae9.webp";
    ...
    >
      <div className="absolute h-[982px] left-[463px] top-0 w-[1049px]">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img
            alt=""
            className="absolute h-full left-[-33.17%] max-w-none top-[0.05%] w-[166.42%]"
            src={imgRectangle1}
          />
        </div>
      </div>
