from app.pred_engine import AI_models, ai_caller
...
class TestTrainTestKnn:
    def test_get_tt_knn(self):
        f = "/workspaces/backend/app/tests/pred_engine_test_files/unit_test_tt_data.csv"
...
#AI_CALLER.PY
####################################################
#do I create the models here once for testing?
