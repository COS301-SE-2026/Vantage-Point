...
class RiotService:
    def __init__(self):
        ...
        self.account_url = "https://europe.api.riotgames.com" # Region (americas, europe, etc)
        self.platform_url = "https://euw1.api.riotgames.com"  # Platform (na1, euw1, etc)    
    ...
    async def get_puuid(self, game_name: str, tag_line: str):
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code != 200:
                raise HTTPException(status_code=response.status_code, detail="Summoner not found")
